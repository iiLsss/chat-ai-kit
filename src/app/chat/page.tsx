...
export default function Home() {
	...
	return (
		<main className='w-full h-screen overflow-hidden text-gray-800'>
			<Header>
				<div onClick={() => setShow()} className='flex items-center justify-center w-8 h-8'>
					<MenuIcon className='' />
				</div>
			</Header>
			...
			<div
				...
				className={clsx(
					'fixed  top-0  bottom-0 left-0 right-0 z-20 w-full h-full  bg-black/25 md:hidden pr-[25%] shadow-left ',
					show ? 'block' : 'hidden'
				)}
			>
				<div
